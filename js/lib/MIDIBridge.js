...
(function() {
    ...
    try {
        console.log("MIDIbridge is ready. For more infos, visit : http://abumarkub.net/midibridge/");
    } catch (e) {
        console = {
            'log': function(args) {}
        };
    ...
    noteNames = {},
    javaDir = "js/lib",//directory of the applet, relative to the directory of the html file
    debug = false,
    onReady = null,
    onError = null,  
